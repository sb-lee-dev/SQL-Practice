...
-- We want to give a bonus to the staff member that handled 
-- the most payments (number of payments)
...
-- We are running a promoting to reward our top 5 customers with coupons.
